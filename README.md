...
<img width="1627" height="912" alt="image" src="https://github.com/user-attachments/assets/a2de7d07-3da8-4995-9084-757b98bd2f51" />
...
项目不是把 prompt 直接拼接后丢给模型，而是实现了一个可重复运行的 Runtime 流程。
